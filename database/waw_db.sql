-- ==========================================
-- STRUKTUR DATABASE FINAL - PROJECT RT/RW
-- ==========================================
...
-- 1. TABEL ADMIN
-- Fungsi: Untuk login Pak RT (Admin Tunggal)
CREATE TABLE `admin` (
...
-- 2. TABEL KELUARGA
-- Fungsi: Wadah pengelompokan warga (Sesuai No KK)
...
-- 3. TABEL WARGA
-- Fungsi: Data individu & Login Warga (Username = NIK)
CREATE TABLE `warga` (
  `nik` varchar(16) NOT NULL,
  `no_kk` varchar(16) NOT NULL,
  `password` varchar(255) NOT NULL,
...
-- 4. TABEL LOG WARGA (HISTORI)
-- Fungsi: Mencatat riwayat perubahan data 
...
-- Fungsi: Tempat data sementara saat warga minta edit
-- Data di sini harus disetujui Admin baru masuk ke tabel Warga
